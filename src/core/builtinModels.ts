...
export const BUILTIN_MODELS: readonly ModelOption[] = [
  ...
  { id: "moonshotai/kimi-k3", provider: "moonshotai", model: "kimi-k3", label: "Kimi K3" },
  { id: "moonshotai/kimi-k2.7-code", provider: "moonshotai", model: "kimi-k2.7-code", label: "Kimi K2.7 Code" },
  { id: "moonshotai/kimi-k2.6", provider: "moonshotai", model: "kimi-k2.6", label: "Kimi K2.6" },
